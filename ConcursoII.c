...
// Declaração de variáveis para Arvores SBB
    ApontadorNo Arvore_inscricao;
    ApontadorNo Arvore_nomes;

// Declaração de variáveis para Tabela Hash
   ...
   // Caso o arquivo não exista, a condição acima será ignorada, pois não há dados a serem carregados
    ...
    if( (arq_lista = fopen("Ficha dos Candidatos.txt","r") ) != NULL && numero_concurso!=0 ){
        ...
        for(l=0; l<cont_linha; l++){
            ...
            // Pega os dados de configuração do arquivo e passa para as variáveis
            // Pega linha a linha com o fgets e passa para a variável com o sscanf
            // Obs: a primeira linha é um #, no caso do primeiro concurso,
            // é um espaço, então, saltamo-la
...
/**************** Fim do processo de carregamento de Dados ******************/
    ...
    do{
        ...
        if( op == 1 ){
            ...
            // Assim, a tabela também será desalocada
            if(flag==1){
                for( i=0; i<MAX; i++ ){
        ...
        // === OPÇÃO 4: Visualizar lista de Aprovados =================
        if ( op == 4 ){
            system("cls");
        ...
        // === OPÇÃO 5: Visualizar lista de Espera =================
        if ( op == 5 ){
            system("cls");
        ...
        // === OPÇÃO 6: Visualizar os historicos de arquivo  =================
        if ( op == 6 ){
...
// Parte para desalocar fila INICIO
            ...
            //==============================
            // Parte de desalocar as árvores SBB inicio
            DesalocaArvore(Arvore_inscricao);
            DesalocaArvore(Arvore_nomes);
            // Parte de desalocar as árvores SBB fim
